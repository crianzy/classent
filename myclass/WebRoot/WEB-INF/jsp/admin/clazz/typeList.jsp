...
function edit_submit(id){
	...
	$.ajax({
		type:"post",
		url:"admin/clazzAdminAction_editClazzType?",
		data:"clazzTypeId="+id+"&clazzTypeName="+$("#name"+id).val(),
...
function del(id){
	if(id!=0){
		location='admin/clazzAdminAction_delClazzType?clazzTypeId='+id;
	}
	else{
		var array = document.getElementsByName("menuId");
		var idstr="";
		...
		if(idstr){
			location='admin/clazzAdminAction_delClazzType?ids='+idstr;
		}
		else{
			alert("您还未选择");
		}
...
<td valign="top">
	<div class="middle">
		<form action="admin/clazzAdminAction_addClazzType" method="post" style="margin:0px;" onsubmit="return check(this)">
		<table width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dae2e5">
			<tr>
			    ...
			    <td width="60%" height="30" bgcolor="#ffffff" align="center">
					<input type="text" name="clazzTypeName"/>	    	
			    </td>
	  ...
	  <table width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dae2e5">
	    <tr>
	      ...
	      <td width="20%" height="30" bgcolor="#e5edfa"><div align="center" class="STYLE3">操作选项 </div></td>
	    	...
	    	<s:if test="#clazzTypeList != null">
	    		<s:iterator value="clazzTypeList" status="vs" >
	    		<tr>
