	...
	<head>
		...
		<script type="text/javascript">
			function changeMenu(menuId){
				if(menuId == 0){
					location="master/masterAction_myTopicList"
				}else{
					location="master/masterAction_myTopicList?topicMenuId="+menuId;
				}
			}
			function gotoPage(num){
				<s:if test="topicMenuId == null">
					location="master/masterAction_myTopicList?currentPage="+num;
				</s:if>
				<s:else>
					location="master/masterAction_myTopicList?topicMenuId=${topicMenuId }&currentPage="+num;
				</s:else>
			}
		</script>
	</head>
